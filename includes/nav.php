<ul id="side_menue" class="nav nav-pills nav-stacked">
	<li><a href="index.php?pagename=dashboard"><i class="fas fa-th"></i> Dashboard</a></li>
	<li><a href="index.php?pagename=add-new-post"><i class="fas fa-file-alt"></i> Add New Post</a></li>
